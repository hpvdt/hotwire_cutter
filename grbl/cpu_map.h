...
#define cpu_map_h
  ...
  // Define stepper driver enable/disable output pin.
  // One pin is used for all steppers for HPVDT's hotwire board
  ...
  #endif
  #define STEPPER_DISABLE_BIT_0 6 // X Enable - Pin D13
  #define STEPPER_DISABLE_BIT_1 6 // Y Enable - Pin D13
  #define STEPPER_DISABLE_BIT_2 6 // Z Enable - Pin D13
  #if N_AXIS > 3
    #define STEPPER_DISABLE_BIT_3 6 // Axis number 4 Step - Pin D13
  #endif
  #if N_AXIS > 4
    #define STEPPER_DISABLE_BIT_4 6 // Axis number 5 Step - Pin D13
  #endif
  #if N_AXIS > 5
    #define STEPPER_DISABLE_BIT_5 6 // Axis number 5 Step - Pin D13
  #endif
  ...
  // Define homing/hard limit switch input pins and limit interrupt vectors.
  // On our board there is no difference made for upper or lower limits
  ...
  #if N_AXIS > 3
    #define MIN_LIMIT_BIT_3 0 // Axis number 4 : D53
  #endif
  #if N_AXIS > 4
    #define MIN_LIMIT_BIT_4 1 // Axis number 5 : D52
  #endif
  #if N_AXIS > 5
    #define MIN_LIMIT_BIT_5 2 // Axis number 6 : D51
  #endif
  ...
  #if N_AXIS > 3
    #define MAX_LIMIT_BIT_3 0 // Axis number 4 : D52
  #endif
  #if N_AXIS > 4
    #define MAX_LIMIT_BIT_4 1 // Axis number 5 : D51
  #endif
  #if N_AXIS > 5
    #define MAX_LIMIT_BIT_5 2 // Axis number 6 : D50
  #endif
  ...
  #define CONTROL_PIN       PINK
  #define CONTROL_PORT      PORTK
  #define CONTROL_RESET_BIT         0  // Pin A8 - RAMPS Aux 2 Port
  #define CONTROL_FEED_HOLD_BIT     1  // Pin A9 - RAMPS Aux 2 Port
  #define CONTROL_CYCLE_START_BIT   2  // Pin A10 - RAMPS Aux 2 Port
  #define CONTROL_SAFETY_DOOR_BIT   3  // Pin A11 - RAMPS Aux 2 Port
  #define CONTROL_INT       PCIE2  // Pin change interrupt enable pin
  #define CONTROL_INT_vect  PCINT2_vect
  #define CONTROL_PCMSK     PCMSK2 // Pin change interrupt register
  #define CONTROL_MASK      ((1<<CONTROL_RESET_BIT)|(1<<CONTROL_FEED_HOLD_BIT)|(1<<CONTROL_CYCLE_START_BIT)|(1<<CONTROL_SAFETY_DOOR_BIT))
...
*/
...
#ifdef CPU_MAP_HPVDT_BOARD // (Arduino Mega 2560) with Ramps 1.4 Board
  #include "nuts_bolts.h"
  ...
  #define STEP_PORT     PORTA
  #define STEP_PIN      PINA
  #define X_STEP_BIT 2  // X Step - Pin D24
  #define Y_STEP_BIT 3  // Y Step - Pin D25
  #define Z_STEP_BIT 4  // Z Step - Pin D26
  #define STEP_MASK ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits
  #if N_AXIS > 3
    #define A_STEP_BIT 5 // Axis number 4 Step - Pin D27
    #define STEP_MASK ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)|(1<<A_STEP_BIT)) // All step bits
  #endif
  #if N_AXIS > 4
    #define B_STEP_BIT 6 // Axis number 5 Step - Pin D28
    #define STEP_MASK ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)|(1<<A_STEP_BIT)|(1<<B_STEP_BIT)) // All step bits
  #endif
  #if N_AXIS > 5
    #define C_STEP_BIT 7 // Axis number 6 Step - Pin D29
  ...
  #define DIRECTION_PORT    PORTC
  #define DIRECTION_PIN     PINC
  #define X_DIRECTION_BIT 7 // X Dir - Pin D30
  #define Y_DIRECTION_BIT 6 // Y Dir - Pin D31
  #define Z_DIRECTION_BIT 5 // Z Dir - Pin D32
  #define DIRECTION_MASK ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits

  #if N_AXIS > 3
    #define A_DIRECTION_BIT 4 // Axis number 4 Step - Pin D33
    #define DIRECTION_MASK ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)|(1<<A_DIRECTION_BIT)) // All direction bits
  #endif
  #if N_AXIS > 4
    #define B_DIRECTION_BIT 3 // Axis number 5 Step - Pin D34
  ...
  #endif
  #if N_AXIS > 5
    #define C_DIRECTION_BIT 2 // Axis number 6 Step - Pin D35
  ...
  #define STEPPERS_DISABLE_DDR   DDRB
  #define STEPPERS_DISABLE_PORT  PORTB
  #define STEPPERS_DISABLE_BIT   6 // MEGA2560 Digital Pin 12
  #define STEPPERS_DISABLE_MASK (1<<STEPPERS_DISABLE_BIT)
