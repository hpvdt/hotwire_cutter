...
#define HOMING_CYCLE_0 ((1<<Z_AXIS)|(1<<U_AXIS))                // REQUIRED: First move Z to clear workspace.
#define HOMING_CYCLE_1 ((1<<X_AXIS)|(1<<Y_AXIS)) // OPTIONAL: Then move X,Y at the same time.
//#define HOMING_CYCLE_2 (1<<Y_AXIS)                        // OPTIONAL: Uncomment and add axes mask to enable
//#define HOMING_CYCLE_3 (1<<Z_AXIS)                        // OPTIONAL: Uncomment and add axes mask to enable
